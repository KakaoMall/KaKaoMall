...
panel_keypair = panel_keypair = {"코드패널 아이디" : "코드패널 비밀번호"} # 라이센스코드 생성할때 로그인할 관리자 계정입니다.
                            ...
                            if (bank_addr != ""):
                                ...
                                if (server_info[19] != None):
                                    ...
                                    def waiting():
                                        ...
                                        jsondata = {
                                            "api_key": "FSWER35", "bankpin": str(server_info[12]), "shop": str(server_info[0]), "userinfo": str(bankname), "userid": str(names), "token": "token", "type": True, "amount": int(amount)
                                        }
                                        print(jsondata)
